...
export const defaultContent: SiteContent = {
  ...
  members: [
    {
      id: '1',
      name: 'Dr Ugochukwu Nweke',
      title: 'Community Member',
      bio: 'Dr Ugochukwu Nweke is a distinguished member of the Nenwe Progressive Association UK, bringing professional expertise and deep commitment to the Nenwe community.\n\nHe is actively involved in the association\'s programmes and continues to serve Ndi Nenwe both in the UK and back home in Nenwe, Enugu State.',
      imageUrl: '/img1.jpg',
    },
    {
      id: '2',
      name: 'Ken K Ejim',
      title: 'Community Member',
      bio: 'Ken K Ejim is a valued member of the Nenwe Progressive Association UK, contributing his skills and energy to the growth and development of the association.\n\nHe remains dedicated to fostering unity among Ndi Nenwe in the diaspora and supporting impactful projects in Nenwe.',
      imageUrl: '/img2.jpg',
    },
    {
      id: '3',
      name: 'Dr Mathew',
      title: 'Community Member',
      bio: 'Dr Mathew is a respected member of the Nenwe Progressive Association UK, bringing medical expertise and community spirit to the association\'s health and welfare initiatives.\n\nHis contributions have helped advance the association\'s mission of improving lives across Nenwe.',
      imageUrl: '/img3.jpg',
    },
    {
      id: '4',
      name: 'Dr Christian Ndubisi',
      title: 'Community Member',
      bio: 'Dr Christian Ndubisi is a committed member of the Nenwe Progressive Association UK, offering professional insight and dedicated service to the Nenwe community.\n\nHe supports the association\'s goals of education, health, and community development in Nenwe, Enugu State.',
      imageUrl: '/img4.jpg',
    },
    {
      id: '5',
      name: 'Udeinya',
      title: 'Community Member',
      bio: 'Udeinya is an active member of the Nenwe Progressive Association UK, passionate about diaspora engagement and the progress of Nenwe.\n\nThrough dedication and community spirit, they continue to make a meaningful contribution to the association\'s work.',
      imageUrl: '/img5.jpg',
    },
  ],
